...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const submitButton = document.querySelector('.template-btn[data-id="1"]');
    ...
    submitButton.addEventListener('click', function (event) {
        ...
        const describeText = document.getElementById('userInput').value;

        const situationsHeading = document.querySelector('.situations_formHeading');
        if (situationsHeading) {
            situationsHeading.textContent = describeText;
        }
    });
});